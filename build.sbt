import sbtrelease.ReleaseStateTransformations.{commitNextVersion, inquireVersions, pushChanges, runClean, runTest, setNextVersion, setReleaseVersion}

name := "cpg dotfile exporter"
...
libraryDependencies ++= Seq(
  ...
  "de.halcony"             %% "scala-dotfile-creator"      % "1.1.2",
